    ...
    <Box bg='gray.800'>
      <Flex alignItems='center' justifyContent='space-between' py='3'>
        ...
        <Box display={['none', 'block']} mr='4'>
          <ChakraLink as={Link} to='/' color='white' fontSize='20px' mr='4'>
            Accueil
          </ChakraLink>
          <ChakraLink as={Link} to='/champions' color='white' fontSize='20px' mr='4'>
            Champions
          </ChakraLink>
          <ChakraLink as={Link} to='/postes' fontSize='20px' color='white'>
            Postes
          </ChakraLink>
        </Box>
        <IconButton
